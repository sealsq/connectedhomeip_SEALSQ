...
// #include <platform/nrfconnect/NRFVic292FactoryDataProvider.h>
// #else
...
private:
    ...
    chip::DeviceLayer::NRFVic292FactoryDataProvider<chip::DeviceLayer::InternalFlashFactoryData> mFactoryDataProvider;
};
